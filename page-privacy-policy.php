...
<!-- End Google Tag Manager -->
    ...
    <title>プライバシーポリシー - 【公式】内定コンサル</title>
    <meta property="og:url" content="https://naitei-consulting.com/privacy-policy/">
    <meta property="og:title" content="プライバシーポリシー - 【公式】内定コンサル">
  ...
  />
    ...
    <link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri() ); ?>/privacy-policy/css/style.css">
    <?php wp_head(); ?>
</head>
...
<!-- End Google Tag Manager (noscript) -->
 ...
 <?php get_header(); ?>
     ...
     <section class="single-section">
      <div class="container">
        <p>株式会社FindUp（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
        ...
        <p>本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。<br>
          <br>
          住所：東京都渋谷区渋谷2-19-15宮益坂ビルディング609<br>
          社名：株式会社FindUp<br>
          Eメールアドレス：findup1007@gmail.com
        </p>
